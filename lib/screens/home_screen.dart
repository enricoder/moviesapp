                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return GestureDetector(
                          ...
                          final route = MaterialPageRoute(builder: (context)=> const DetailMovieScreen(),);
      ...
      floatingActionButton: Container(
        ...
        child: Container(
          ...
          child: RawMaterialButton(
            ...
            child: const Icon(Icons.shuffle_rounded, color: Colors.white, size:32.0)
          ),
        ),
      ),
          ...
          child: Row(
            ...
            children: [
              Expanded(
                child: IconButton(
                  onPressed: () {},
                  icon: const Icon(Icons.home_filled, color: Colors.white, size:34.0),
                ),
              ),
              Expanded(
                child: IconButton(
                  onPressed: () {},
                  icon: const Icon(Icons.play_arrow_rounded , color: Colors.white, size:34.0),
                ),
              ),
              const Expanded(
                child: Text(''),
              ...
              Expanded(
                child: IconButton(
                  onPressed: () {},
                  icon: const Icon(Icons.list_rounded , color: Colors.white, size:34.0),
              ...
              Expanded(
                child: IconButton(
                  onPressed: () {},
                  icon: const Icon(Icons.download_rounded , color: Colors.white, size:34.0),
