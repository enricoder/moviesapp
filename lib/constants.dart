...
class Constants {
  // Constant Color
  static const Color kPinkColor = Color(0xFFFF0000);
  static const Color kCyanColor = Color.fromARGB(255, 213, 254, 8);
  static const Color kGreenColor = Color.fromARGB(255, 251, 186, 9);
